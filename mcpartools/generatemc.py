...
from mcpartools.generator import Generator, Options
...
def main(args=sys.argv[1:]):
    ...
    parser.add_argument("-V", "--version", action="version", version=mcpartools.__version__)
    parser.add_argument(
        "-v",
        "--verbose",
        action="count",
    ...
    parser.add_argument("-w", "--workspace", type=str, help="workspace directory")
    parser.add_argument("-m", "--mc_run_template", type=str, default=None, help="path to optional MC run script")
    parser.add_argument(
        "-s",
        "--scheduler_options",
        type=str,
    ...
    parser.add_argument(
        "-c", "--collect", type=str, default="mv", choices=Options.collect_methods, help="Available collect methods"
    )
    parser.add_argument(
        "-p",
        "--particle_no",
    ...
    parser.add_argument("-j", "--jobs_no", type=int, required=True, help="number of parallel jobs")
    parser.add_argument("input", type=str, help="path to input configuration")
